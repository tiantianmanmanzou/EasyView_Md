...
/**
 * Build a real .xlsx workbook from the table payload produced by the webview.
 * The output mirrors the on-page table: thin grid borders, merged cells, column
 * widths, row heights, alignment and bold header text.
 */
export async function buildXlsxBuffer(payload: XlsxTablePayload): Promise<Buffer> {
