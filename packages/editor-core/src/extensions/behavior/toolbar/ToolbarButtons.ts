...
export function createToolbarButtons(toggleLink: LinkPopupToggle): ToolbarButton[] {
  return [
  {
    ...
    title: `Bold (${PRIMARY_MODIFIER_LABEL}+B)`,
  ...
  },
  {
    ...
    title: `Italic (${PRIMARY_MODIFIER_LABEL}+I)`,
  ...
  },
  {
    ...
    title: `Underline (${PRIMARY_MODIFIER_LABEL}+U)`,
  ...
  },
  {
    ...
    title: `Strikethrough (${PRIMARY_MODIFIER_LABEL}+D)`,
    command: toggleMark(schema.marks.strikethrough),
    isActive: (state) => isMarkActive(state, schema.marks.strikethrough),
  },
  {
    id: 'text-color',
    icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 20h14"/><path d="M8 16 12 4l4 12"/><path d="M9.5 12h5"/></svg>',
    title: 'Text Color',
    command: toggleMark(schema.marks.text_color, { color: '#d946ef' }),
    isActive: (state) => isMarkActive(state, schema.marks.text_color),
  },
  {
    id: 'highlight',
    ...
    title: `Highlight (${PRIMARY_MODIFIER_LABEL}+Shift+H)`,
  ...
  },
  {
    ...
    title: `Code (${PRIMARY_MODIFIER_LABEL}+E)`,
  ...
  },
  {
    ...
    title: `Blockquote (${PRIMARY_MODIFIER_LABEL}+Shift+B)`,
  ...
  },
  {
    ...
    title: `Heading 1 (${PRIMARY_MODIFIER_LABEL}+Shift+1)`,
    command: (state, dispatch) => {
  ...
  },
  {
    ...
    title: `Heading 2 (${PRIMARY_MODIFIER_LABEL}+Shift+2)`,
    command: (state, dispatch) => {
  ...
  },
  {
    ...
    title: `Heading 3 (${PRIMARY_MODIFIER_LABEL}+Shift+3)`,
    command: (state, dispatch) => {
  ...
  },
  {
    ...
    title: `Checkbox List (${PRIMARY_MODIFIER_LABEL}+Shift+7)`,
  ...
  },
  {
    ...
    title: `Bullet List (${PRIMARY_MODIFIER_LABEL}+Shift+8)`,
    command: (state, dispatch, view) => {
      const closestList = getClosestListType(state);
  ...
  },
  {
    ...
    title: `Ordered List (${PRIMARY_MODIFIER_LABEL}+Shift+9)`,
    command: (state, dispatch, view) => {
      const closestList = getClosestListType(state);
  ...
  },
  {
    ...
    title: `Note (${PRIMARY_MODIFIER_LABEL}+Shift+N)`,
    command: (state, dispatch) => {
