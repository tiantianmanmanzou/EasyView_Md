...
- **目标**：
  ...
  - > [!important]
    > **数据管理**：协议基础主数据，用于填报与台账关联，包含规则条ßß款版ß本。
...
| ------ | -------------------------------------- | -------------------------------------- | ------------------- | --------------------------------------------------- | --------------------------------------- | ------------------------------ |
| 计划管理   | 综合运营流程 > 业务运营流程 > 协同评估 > 计划管理 挨打的阿德ADFA | 管理周期工单任务，支持发布成员登记/事项评估工单客家话55          | 查询筛选、计划列表、二级工单列表、分页 | 计划配置 -> 周期生成工单 -> 待办分发 -> 执行回写                      | 列表、发布弹窗、计划详情、二级工单下钻                     | 接收组织关联成员                       |
...
- 分页区：页码、每页条数、总数。
- ![](./Sample.assets/Sample-1779918098874.png){width=231}
